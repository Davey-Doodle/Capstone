...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names= 'class',
        title=('Rate of Successful launches at site '+ entered_site)
        )
        return fig
...
def get_scatter_chart(entered_site, payload_range):
    print('Params: {} {}'.format(entered_site, payload_range))	# Thanks to the instructor, Pratishka Verma, for help with this part
    if entered_site == 'ALL':	
...
# useful commands to get the libraries and data
